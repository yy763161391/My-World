    ...
    var obj = {
        ...
        bindEvent:function(){
            ...
            $('#submit-add').on('click',function(){
                ...
                $.ajax({
                    url:'api.duyiedu.com/api/student/addStudent?appkey=yinwensong_1550025623499',
                    data : data,
                    success:function(){
                        alert('新增成功');
        ...
        show:function(){
            ...
            $('.edit').on('click',function(){
                ...
                $('.submit').on('click',function(){
                    ...
                    $.ajax({
                        url:'api.duyiedu.com/api/student/updateStudent?appkey=yinwensong_1550025623499',
                        data:data,
                        dataType: 'json',
                        success:function(){
                                alert('提交成功');     
            ...
            $('.del').on('click',function(){
                ...
                $('.sure-btn').on('click',function(){
                    $.ajax({
                    url:'api.duyiedu.com/api/student/delBySno?appkey=yinwensong_1550025623499',
                    data:{sNo:num},
                    success:function(){
                        alert('删除成功');
                        $('.del-modal').hide();
